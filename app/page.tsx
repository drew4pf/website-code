...
export default function Home() {
  ...
  const products = [
    ...
    { name: "Bluetooth Speaker", tag: "Tech", badge: "Popular", score: 88, image: "https://images.unsplash.com/photo-1589254065878-42c9da997008?q=80&w=1400&auto=format&fit=crop", link: `https://www.amazon.com/s?k=bluetooth+speaker&tag=${amazonTag}` },
    { name: "Portable Power Bank", tag: "Tech", badge: "Essential", score: 90, image: "https://images.unsplash.com/photo-1609592806596-4d5c2b3b8a8d?q=80&w=1400&auto=format&fit=crop", link: `https://www.amazon.com/s?k=power+bank&tag=${amazonTag}` },
    { name: "USB-C Hub Dock", tag: "Tech", badge: "Setup Tool", score: 86, image: "https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?q=80&w=1400&auto=format&fit=crop", link: `https://www.amazon.com/s?k=usb+c+hub&tag=${amazonTag}` },
    ...
    { name: "Gaming Mouse", tag: "Tech", badge: "Gaming", score: 87, image: "https://images.unsplash.com/photo-1527814050087-3793815479db?q=80&w=1400&auto=format&fit=crop", link: `https://www.amazon.com/s?k=gaming+mouse&tag=${amazonTag}` },
    { name: "Mechanical Keyboard", tag: "Tech", badge: "Setup Tool", score: 89, image: "https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?q=80&w=1400&auto=format&fit=crop", link: `https://www.amazon.com/s?k=mechanical+keyboard&tag=${amazonTag}` },
    ...
    { name: "Ergonomic Office Chair", tag: "Setup", badge: "Comfort", score: 94, image: "https://images.unsplash.com/photo-1505842465776-3b4953ca4f8f?q=80&w=1400&auto=format&fit=crop", link: `https://www.amazon.com/s?k=ergonomic+chair&tag=${amazonTag}` },
